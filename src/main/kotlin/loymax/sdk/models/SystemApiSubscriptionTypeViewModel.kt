 ...
 * @param timeUnit 
 * @param hiddenTemplate Тип подписки скрыт в шаблонах.
 */

data class SystemApiSubscriptionTypeViewModel (
    ...
    @Json(name = "hiddenTemplate")
    var hiddenTemplate: kotlin.Boolean? = null
