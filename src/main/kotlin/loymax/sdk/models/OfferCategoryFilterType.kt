...
enum class OfferCategoryFilterType(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is OfferCategoryFilterType) "$data" else null

        /**
         * Returns a valid [OfferCategoryFilterType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): OfferCategoryFilterType? = data?.let {
