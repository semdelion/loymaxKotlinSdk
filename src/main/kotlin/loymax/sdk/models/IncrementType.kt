...
enum class IncrementType(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is IncrementType) "$data" else null

        /**
         * Returns a valid [IncrementType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): IncrementType? = data?.let {
