...
enum class MailingTimeLimitType(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is MailingTimeLimitType) "$data" else null

        /**
         * Returns a valid [MailingTimeLimitType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): MailingTimeLimitType? = data?.let {
