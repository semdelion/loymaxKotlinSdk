...
enum class RefundNegativeType(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is RefundNegativeType) "$data" else null

        /**
         * Returns a valid [RefundNegativeType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): RefundNegativeType? = data?.let {
