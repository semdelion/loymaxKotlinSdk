...
import loymax.sdk.models.StripNumbers
 ...
 * @param pinCode PIN-код.
 * @param strips 
 * @param canUnBlocking Возможна ли разблокировка карты (true-разблокировка возможна, false-разблокировка невозможна).
 * @param isCvcCodeRequired Признак необходимости CVC-кода для проверки карты (true-CVC-код необходим, false-CVC-код не требуется).
 * @param parentCardId Родительская карта для текущей.
 */

data class SecondaryCardInfoModel (
