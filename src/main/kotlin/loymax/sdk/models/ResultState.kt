...
enum class ResultState(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is ResultState) "$data" else null

        /**
         * Returns a valid [ResultState] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): ResultState? = data?.let {
