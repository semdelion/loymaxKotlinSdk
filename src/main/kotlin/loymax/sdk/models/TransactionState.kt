...
enum class TransactionState(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is TransactionState) "$data" else null

        /**
         * Returns a valid [TransactionState] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): TransactionState? = data?.let {
