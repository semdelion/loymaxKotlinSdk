...
enum class AccountChangeType(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is AccountChangeType) "$data" else null

        /**
         * Returns a valid [AccountChangeType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): AccountChangeType? = data?.let {
