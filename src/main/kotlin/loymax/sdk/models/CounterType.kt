...
enum class CounterType(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is CounterType) "$data" else null

        /**
         * Returns a valid [CounterType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): CounterType? = data?.let {
