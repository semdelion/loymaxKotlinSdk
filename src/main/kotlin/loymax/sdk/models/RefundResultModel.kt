...
import loymax.sdk.models.GiftCertificateModel
 ...
 * @param amount Сумма скидки, которую нужно предоставить (в валюте кассы).
 * @param bonusAmount Сумма списанных бонусов.
 * @param giftCertificates Список подарочных сертификатов в чеке.
 * @param refundOperationType Тип возврата.
 */

data class RefundResultModel (
    ...
    @Json(name = "bonusAmount")
    var bonusAmount: kotlin.Double? = null,

    /* Список подарочных сертификатов в чеке. */
    @Json(name = "giftCertificates")
    var giftCertificates: kotlin.collections.MutableList<GiftCertificateModel>? = null,

    /* Тип возврата. */
    @Json(name = "refundOperationType")
    var refundOperationType: kotlin.String? = null
