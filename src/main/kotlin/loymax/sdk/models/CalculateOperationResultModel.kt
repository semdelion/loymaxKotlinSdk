...
import loymax.sdk.models.GiftCertificate
 ...
 * @param availableAmount Максимально возможный размер скидки, предоставляемый за списание бонусов.
 * @param availableBonusAmount Максимально возможное количество бонусов, которые можно списать в данной покупке.
 * @param balance Баланс.
 * @param giftCertificates Подарочные сертификаты.
 */

data class CalculateOperationResultModel (
    ...
    @Json(name = "giftCertificates")
    var giftCertificates: kotlin.collections.MutableList<GiftCertificate>? = null
