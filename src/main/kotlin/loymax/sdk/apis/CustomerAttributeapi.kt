...
import loymax.sdk.models.ResultModelOfBaseUserAttributeViewModel
import loymax.sdk.models.ResultModelOfInt32
import loymax.sdk.models.ResultModelOfPagedViewModelOfBaseUserAttributeViewModel
import loymax.sdk.models.UserAttributeType

interface CustomerAttributeapi {
    /**
     * Удалить атрибут.
     * 
     * Responses:
    ...
    fun customerAttributeUpdateAttribute(@Path("id") id: kotlin.Int, @Query("id") id: kotlin.Int? = null, @Query("name") name: kotlin.String? = null, @Query("order") order: kotlin.Int? = null, @Query("logicalName") logicalName: kotlin.String? = null, @Query("historyIsRecorded") historyIsRecorded: kotlin.Boolean? = null): Call<ResultModel>
