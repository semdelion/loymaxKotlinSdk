...
import loymax.sdk.models.PersonalOfferAttributeValueModel
import loymax.sdk.models.ResultModel
import loymax.sdk.models.ResultModelOfCommonAttributeJsonModel
import loymax.sdk.models.ResultModelOfListOfPersonalOfferAttributeValueModel
import loymax.sdk.models.ResultModelOfPagedViewModelOfFavoriteGoodsCommonViewModel
...
interface UserAttributesapi {
    ...
    fun userAttributesSetPersonalOfferAttribute(@Path("attributeId") attributeId: kotlin.Int, @Query("goodsIds") goodsIds: kotlin.collections.MutableList<kotlin.Int>? = null, @Query("attributeId") attributeId: kotlin.Int? = null): Call<ResultModel>
